...
export default function BinderViewer({ binder, isEditMode, selectedStickerId, onSlotClick, onRenamePage, onDeletePage, onStickerView }: BinderViewerProps) {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-[1360px] h-[92vh] flex items-center justify-center cursor-grab active:cursor-grabbing"
    ...
    >
      <div className="relative w-full h-full flex [transform-style:preserve-3d]">
        ...
        <div className="w-1/2 h-full relative z-10">
          <Page page={spreads[A_index].left} side="left" interactive={!isFlipping} isEditMode={isEditMode} selectedStickerId={selectedStickerId} onSlotClick={onSlotClick} onRenamePage={onRenamePage} onDeletePage={onDeletePage} onStickerView={onStickerView} />
          {isFlipping && (
        ...
        {/* STATIC RIGHT PAGE */}
        <div className="w-1/2 h-full relative z-10">
          <Page page={spreads[B_index].right} side="right" interactive={!isFlipping} isEditMode={isEditMode} selectedStickerId={selectedStickerId} onSlotClick={onSlotClick} onRenamePage={onRenamePage} onDeletePage={onDeletePage} onStickerView={onStickerView} />
          {isFlipping && (
...
function Page({ page, side, interactive, isEditMode, selectedStickerId, onSlotClick, onRenamePage, onDeletePage, onStickerView }: {
  ...
  return (
    ...
    `}>
      ...
      <div className="relative z-30 p-6 md:p-10 h-full flex flex-col overflow-hidden">
        <PageContent page={page} interactive={interactive} isEditMode={isEditMode} selectedStickerId={selectedStickerId} onSlotClick={onSlotClick} onRenamePage={onRenamePage} onDeletePage={onDeletePage} onStickerView={onStickerView} />
      </div>
    </div>
  );
}

function PageContent({ page, interactive, isEditMode, selectedStickerId, onSlotClick, onRenamePage, onDeletePage, onStickerView }: {
  page: BinderPageOut | null;
  interactive: boolean;
  isEditMode?: boolean;
  selectedStickerId?: number | null;
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${isViewClickable ? 'cursor-pointer hover:brightness-110' : ''}
