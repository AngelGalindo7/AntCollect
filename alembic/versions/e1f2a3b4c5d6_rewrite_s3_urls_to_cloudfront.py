...
# Matches both virtual-host and path-style S3 URLs and captures the key.
# Virtual-host: https://bucket.s3.region.amazonaws.com/key
# Path-style:   https://s3.region.amazonaws.com/bucket/key  (rare, not used here)
...
def downgrade() -> None:
    ...
    # which are not stored in this migration. Re-run with the old env to restore.
    pass
